...
module.exports = {
    ...
    run : async(client, message) => {
        if(message.channel.parentID !== '1148677128196472935') return message.channel.send('You can only use this command in a ticket!');
        const transcriptChannel = message.guild.channels.cache.get('1157604854290710538')
